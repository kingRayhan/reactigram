    ...
    <div className="mb-10 bg-white border rounded feed-item border-gray-primary">
      <div className="flex items-center justify-between px-4 py-2 border-b header">
        <div className="flex flex-row items-center left">
          <div className="w-10 h-10 mr-4 overflow-hidden border rounded-full">
            <img
      ...
      <div className="p-4 card-footer">
        <div className="top">
          <div className="flex flex-row items-center justify-between icons">
            <div className="flex flex-row left">
              <div className="mr-4 like">
                <svg
                  aria-label="Like"
                  className="_8-yf5 "
                  fill="#262626"
