...
const Post = () => {
  return (
    <div className="feed-item border border-gray-primary rounded bg-white mb-10">
      <div className="header border-b px-4 py-2 flex justify-between items-center">
        <div className="left flex flex-row items-center">
          <div className="h-10 w-10 border rounded-full overflow-hidden mr-4">
            <img
